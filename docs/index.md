...
17. [Session and Flash Messages](session_and_flash_messages)
18. [Tinker Command](tinker)
19. [Unit Tests](unit_tests)
20. [User Guide](user_guide)
    * A. [Setup With Jekyll](jekyll_setup)
21. [User Profiles](user_profiles)
22. [User Registration and Authentication](user_registration_and_authentication)
23. [Utilities](utilities)
    ...
    * E. [Time](time)
    * F. [Uploads](uploads)
24. [Views Introduction](views_intro)
