...
7. [Database Migrations and Operations](database_operations)
    * A. [Database Queries](database_queries)
    * B. [Factories](factories)
    * C. [Database Seeders](database_seeders)
8. [Debugging and Logs](debugging_and_logs)
9. [Directory Structure](directory_structure)
10. [Events/Listeners](events)
11. Forms
...
16. [Mailer Service](email)
17. [Models](models)
18. [Notifications](notifications)
19. [Queue / Job Dispatcher](queue)
20. [React.js](react)
...
23. [Session and Flash Messages](session_and_flash_messages)
24. [Supported Traits](traits)
25. [Tinker Command](tinker)
26. [Unit Tests](unit_tests)
    * A. [Unit Test Configuration](unit_test_configuration)
    * A. [Unit Tests API](unit_tests_api)
    * B. [PHPUnit](php_unit)
    * C. [Vitest](vitest)
27. [User Guide](user_guide)
  * A. [Setup With Jekyll](jekyll_setup)
28. [User Profiles](user_profiles)
29. [User Registration and Authentication](user_registration_and_authentication)
30. Utilities
    * A. [Arr Class](arr)
    ...
    * E. [DateTime](time)
    * F. [Uploads](uploads)
31. [Views Introduction](views_intro)
